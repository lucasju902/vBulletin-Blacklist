...
*
* @package	vBulletin
* @version	$Revision: 17682 $
* @date		$Date: 2007-07-23 11:36:10 -0500 (Mon, 23 Jul 2007) $
*/
	...
	*/
	...
	function post_save_each($doquery = true)
	{
		...
		if (!$this->condition)
		{
			...
			{
				$this->dbobject->query("UPDATE " . TABLE_PREFIX . "pm SET messageread = " . ($this->info['forward'] ? 3 : 2) . " WHERE userid = $fromuserid AND pmid = " . $this->info['parentpmid']);
			}
		}
