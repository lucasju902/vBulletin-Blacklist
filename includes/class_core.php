...
define('FILE_VERSION', '3.6.11'); // this should match install.php
define('SIMPLE_VERSION', '3611'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 27533 $
* @date		$Date: 2008-08-22 05:12:24 -0500 (Fri, 22 Aug 2008) $
*/
class vB_Database
{
	/**
	...
	*/
	function fetch_scriptpath()
	{
		...
		else
		{
			...
			$reloadurlpath = $scriptpath;
			$this->registry->reloadurl = $this->xss_clean($reloadurlpath);
