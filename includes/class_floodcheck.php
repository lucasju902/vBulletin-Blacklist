...
*
* @package	vBulletin
* @version	$Revision: 25481 $
* @date		$Date: 2008-01-17 10:41:31 -0600 (Thu, 17 Jan 2008) $
*/
class vB_FloodCheck
{
	/**
	...
	*/
	function commit_clause($where_clause, $commit_value, $floodmin_value, $order_by = '')
	{
		...
		$this->commit_value = intval($commit_value); // eg, TIMENOW
		$floodmin_value = intval($floodmin_value); // eg, TIMENOW - 30
