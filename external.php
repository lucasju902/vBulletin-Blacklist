...
if ($vbulletin->GPC['forumids'] != '')
{
	...
	foreach ($forumids AS $forumid)
	{
		...
		if (isset($vbulletin->forumcache["$forumid"])
			...
			AND (($forumperms & $vbulletin->bf_ugp_forumpermissions['canviewthreads']) OR in_array($vbulletin->GPC['type'], array('JS', 'XML'))) // JS only shows titles
