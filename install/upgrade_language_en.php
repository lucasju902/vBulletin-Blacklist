...
$upgradecore_phrases['backup_after_upgrade'] = '<p class="smallfont">Backups must be ran prior to the upgrade, if the upgrade is complete please use the Admin Control Panel.</p>
		<p class="smallfont">For a foolproof backup, login to your server via Telnet or SSH and use the <i>mysqldump</i>
		command on the command line. For more details,
		<a href="http://www.vbulletin.com/manual/html/manual_database_backup" target="_blank">read this</a>.</p>';
...
$upgrade_phrases['upgrade_369.php']['steps'] =& $upgrade_phrases['upgrade_360b3.php']['steps'];

$upgrade_phrases['upgrade_3610.php']['steps'] = array(
	1 => 'Applying critical template changes',
	2 => 'Upgrade to vBulletin ' . VERSION . ' Complete!'
);
$upgrade_phrases['upgrade_3610.php']['token_added_x_templates'] = 'Adding required security token to %1$s customized template(s)';

$upgrade_phrases['upgrade_3611.php']['weak_password_notice'] = 'Weak Password Notice';
$upgrade_phrases['upgrade_3611.php']['weak_password_description'] = 'In this version, users may no longer set their password to be the same as their username. Users affected by this will be forced to change their password on their first login. Additionally, a tool has been added to the Admin Control Panel to reset these users\' passwords.';
$upgrade_phrases['upgrade_3611.php']['steps'] = array(
	1 => 'Upgrade to vBulletin ' . VERSION . ' Complete!'
);
