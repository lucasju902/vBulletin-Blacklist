...
define('CVS_REVISION', '$RCSfile$ - $Revision: 26525 $');
...
if ($_REQUEST['do'] == 'productadd' OR $_REQUEST['do'] == 'productedit')
{
	...
	else
	{
		...
		print_input_row($vbphrase['product_id'], 'productid', '', true, 70, 25); // max length = 25
	}

	print_input_row($vbphrase['title'], 'title', $product['title'], true, 70, 50);
	print_input_row($vbphrase['version'], 'version', $product['version'], true, 70);
	print_input_row($vbphrase['description'], 'description', $product['description'], true, 70);
	print_input_row($vbphrase['product_url'], 'url', $product['url'], true, 70, 250);
	print_input_row($vbphrase['version_check_url'], 'versioncheckurl', $product['versioncheckurl'], true, 70, 250);
